...
function applyPerfectFreehandToVectorNodes(nodeIds, { options, easing, clip, }) {
    for (let id of nodeIds) {
        let node;
        if (previousNodes[id]) {
